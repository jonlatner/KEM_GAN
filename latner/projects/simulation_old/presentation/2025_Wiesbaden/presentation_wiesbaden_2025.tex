...
\begin{minipage}[t]{0.48\textwidth}
    \begin{table}[]
        ...
        \input{../../tables/old/table_disclosure_risk_10_summary.tex}
...
\begin{minipage}{0.48\textwidth}
    \begin{figure}
        \centering
        \caption{cp}
        \includegraphics[width=\textwidth]{../../graphs/old/2025_02_28/graph_cart_modified_cp_histogram_compare_10_v2.pdf}
    \end{figure}
\end{minipage}
}
...
\begin{minipage}{0.48\textwidth}
    \begin{figure}
        \centering
        \caption{mb = 75}
        \includegraphics[width=\textwidth]{../../graphs/old/2025_02_28/graph_attacker_modified_mb_v2.pdf}
    \end{figure}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \begin{figure}
        \centering
        \caption{cp = 0.05}
        \includegraphics[width=\textwidth]{../../graphs/old/2025_02_28/graph_attacker_modified_cp_v2.pdf}
    \end{figure}
\end{minipage}
}
...
\begin{figure}[!h]
    ...
    \resizebox{\textwidth}{!}{\includegraphics{../../graphs/old/2025_02_28/graph_dp_datasynthesizer_compare_histogram_10_v2.pdf}}
...
\begin{figure}[!h]
    \centering
    \caption{}
    \resizebox{\textwidth}{!}{\includegraphics{../../graphs/old/2025_02_28/graph_ctree_cart_factor_histogram_compare_10.pdf}}
...
\begin{figure}[!h]
    \centering
    \caption{}
    \resizebox{\textwidth}{!}{\includegraphics{../../graphs/old/2025_02_28/graph_tree_combined.pdf}}
