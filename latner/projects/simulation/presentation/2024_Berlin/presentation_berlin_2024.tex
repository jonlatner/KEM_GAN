...
\begin{itemize}
    \item CART (synthpop) generates synthetic data with both high utility and low risk
...
\begin{itemize}
    ...
    \item The bad news: why would we solve the problem if we did not know it existed?
\end{itemize}
...
\frame{\frametitle{Summary}
\begin{itemize}
    \item You can solve the risk of disclosure by reducing utility
    \item The bad news: why would you reduce utility, if you did not know there was a risk of disclosure
    \item More generally: how do we know privacy measures are effective in identifying the problem?
\end{itemize}
}
