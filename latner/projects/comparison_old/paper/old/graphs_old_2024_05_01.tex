...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \resizebox{.9\textwidth}{!}{\includegraphics{../graphs/compare_nofriend_1.pdf}}
    ...
    \begin{subfigure}{\textwidth}
        \centering        
        \caption{BMI}
        \resizebox{.9\textwidth}{!}{\includegraphics{../graphs/compare_bmi_1.pdf}}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \resizebox{.9\textwidth}{!}{\includegraphics{../graphs/compare_wkabdur_1.pdf}}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \resizebox{.9\textwidth}{!}{\includegraphics{../graphs/graph_compare_roe.pdf}}
