...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item How computationally efficient are they with respect to data dimensionality?
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Informative (i.e. for single individuals, month married is missing)
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Will only capture missing values if parents ($k$) $>=2$ (is this a bug?)
...
\begin{itemize}
    ...
    \end{itemize}
    \item There are others (i.e. learning rate, weight decay, etc.)
\end{itemize}
}
...
\frame{\frametitle{Summary}
\begin{itemize}
    \item CTGAN is not a good SDG, but \dots
    \begin{itemize}
         \item For this particular dataset
         \item We could still alter hyperparameter
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Errors
            \item Uninformed/informed missings
            \item Generated variables
        \end{itemize}
        \item Unlikely that you can just give your data to someone else and they do it for you
        \begin{itemize}
            \item but they may know the genator well
            \item problem is that people who know the data are separated from people who know the generator (which is best, how to use/tune, etc.)
        \end{itemize}
    \end{itemize}
    \item Know your synthesizer
    \begin{itemize}
        \item Its hard
        \item There is no one size fits all
        \item Each of the three generators has their own things that you need to know
...
% What are the two axis?  The trade-off is not utility vs. privacy.  Its privacy and something else, and utility is what you get out of the combination of the two.  It could be that you only protect privacy by not releasing any data.  

% Do synthesize complete data, but do not synthesize unnecessary variables that are often included in data.  However, if your goal is also to synthesize errors as they were in the original dataset, then you should synthesize it.

% Slide 13.  Get description from Jörg.

% Slide 14, 16, 18.  Labels
\end{spacing}
\end{document}
