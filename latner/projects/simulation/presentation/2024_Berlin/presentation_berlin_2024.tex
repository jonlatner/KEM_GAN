...
\begin{itemize}
    \item No, this is not a problem.  It is not realistic to assume that 
    \begin{itemize}
        \item A synthetic dataset would be generated with only binary variables 
        \item A scenario where an intruder would know all observations except one 
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item It is well known that SDGs struggle to protect unique records
        \end{itemize}
        \item The simulation
        \begin{itemize}
            \item We show that disclosure happened
            \item We show that risk measures did not capture the disclosure
        \end{itemize}
    \end{itemize}
\end{itemize}
}
...
\begin{itemize}
    \item We are not saying that
    \begin{itemize}
        \item Synthetic data are disclosive
        \item CART-based SDGs are disclosive
    \end{itemize}
    \item Instead, we are saying
    \begin{itemize}
        \item Do not assume that risk measures will identify all problems
