...
\begin{figure}[ht!]
    ...
    \resizebox{.9\textwidth}{!}{\includegraphics{../graphs//datasynthesizer_wkabdur.pdf}}
...
\begin{figure}[ht!]
    ...
    \resizebox{.9\textwidth}{!}{\includegraphics{../graphs//datasynthesizer_frequency_agegr_errors.pdf}}
...
\begin{figure}[ht!]
    ...
    \resizebox{.9\textwidth}{!}{\includegraphics{../graphs//datasynthesizer_bmi.pdf}}
...
\begin{figure}[ht!]
    ...
    \resizebox{.9\textwidth}{!}{\includegraphics{../graphs//datasynthesizer_nofriend.pdf}}
...
\begin{figure}[ht!]
    ...
    \resizebox{.9\textwidth}{!}{\includegraphics{../graphs/compare_ds_bmi.pdf}}
...
\begin{figure}
    ...
    \resizebox{.8\textwidth}{!}{\includegraphics{../graphs/ctgan_fidelity_optimize_batch_size.pdf}}
...
\begin{figure}
    ...
    \resizebox{.8\textwidth}{!}{\includegraphics{../graphs/ctgan_fidelity_optimize_epochs.pdf}}
...
\begin{figure}
    ...
    \resizebox{.8\textwidth}{!}{\includegraphics{../graphs/ctgan_fidelity_optimize_dimensions.pdf}}
