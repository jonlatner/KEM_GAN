...
\begin{itemize}
    ...
    \begin{itemize}
        \item Synthetic data is not automatically private. 
        \item Evaluating the privacy can be problematic.
        \begin{itemize}
            \item Privacy is a function of the mechanism that generated a synthetic dataset.
            \item Can privacy be evaluated by comparing synthetic and real data? 
        \end{itemize}
    \end{itemize}
    \item There is no one measure for utility, fidelity, or privacy
    \begin{itemize}
    ...
    \end{itemize}
    \item Efficiency (duration in time) is important and often ignored.  The algorithm should scale well with the dimension of the data space in a relational way, not exponential way
\end{itemize}
}
