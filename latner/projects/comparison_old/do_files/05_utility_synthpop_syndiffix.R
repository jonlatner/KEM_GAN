...
df_compare_mean_cio_little$sdg <- "syndiffix"
...
df_compare_mean_cio_synthpop$sdg <- "syndiffix"
...
df_regression_data_glm$sdg <- "syndiffix"
...
df_regression_data_lm$sdg <- "syndiffix"
...
# Save output 
write.csv(df_regression_data, paste0(tables,"syndiffix_utility_regression_plot.csv"), row.names=FALSE)
write.csv(df_regression_cio, paste0(tables,"syndiffix_utility_regression_cio.csv"), row.names=FALSE)
