...
\begin{figure}[!h]
    ...
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/datasynthesizer/graph_datasynthesizer_continuous_distribution.pdf}}
    \label{graph_datasynthesizer_continuous_distribution}
\end{figure}

\begin{figure}[!h]
    \centering
    \caption{Frequency of estimates}
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/datasynthesizer/graph_datasynthesizer_continuous_deciles.pdf}}
    \label{graph_datasynthesizer_continuous_deciles}
\end{figure}
