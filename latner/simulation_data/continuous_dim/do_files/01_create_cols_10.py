...
for r in rows:
    ...
    all_vars = {**normal_vars, **left_skewed_vars}
    ...
    filename = f"ods_rows_{r}_cols_10.csv"
...
g = sns.FacetGrid(df_long, col='Variable', col_wrap=5, sharex=True, sharey=True, height=3)
