...
sys.path.append('/Users/jonathanlatner/Documents/GitHub/KEM_GAN/latner/data/benchmark/do_files/')
...
filename_path_ods = os.path.join(main_dir,original_data, filename_ods)

filename_sds = "sds_synthpop_sd2011_m_1_n_1.csv"
filename_path_sds = os.path.join(main_dir,synthetic_data, filename_sds)

ods = "filename_path_ods"
synth = "filename_path_sds"
...
tcap(original=ods, synth=synth, target=target, keys=keys, num_keys=num_keys)
