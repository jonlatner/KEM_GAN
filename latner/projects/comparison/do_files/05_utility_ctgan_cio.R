...
epochs = c(600) # the idea is that you already optimized epochs
...
df_regression_data_glm$sdg <- "ctgan"
...
df_regression_data_lm$sdg <- "ctgan"
...
write.csv(df_regression_cio, paste0(tables,"ctgan_utility_regression_cio.csv"), row.names=FALSE)
