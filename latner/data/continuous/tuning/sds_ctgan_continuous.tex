...
%     \resizebox{\textwidth}{!}{\includegraphics{../graphs/ctgan/graph_ctgan_continuous_distribution.pdf}}
%     \label{graph_ctgan_continuous_distribution}
% \end{figure}

\begin{figure}[!h]
    \centering
    \caption{Frequency of estimates}
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/ctgan/graph_ctgan_continuous_deciles.pdf}}
